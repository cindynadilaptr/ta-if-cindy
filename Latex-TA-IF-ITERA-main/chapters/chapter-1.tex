...
Di Indonesia, kasus \textit{stunting} terjadi pada balita usia 0-5 tahun berada pada persentase sebesar 19,8\% menurut Survei Status Gizi Indonesia (SSGI) \cite{kemenkes2025ssgi}. Meskipun telah mengalami penurunan dari tahun sebelumnya yaitu angka 21,5\%, hasil ini menunjukan bahwa target pemerintah Indonesia yaitu menurunkan prevalensi \textit{stunting} sampai 14,4\% di tahun 2029 masih belum tercapai \cite{bkpk2023ski}, \cite{setneg2024strategi}. Kondisi ini menegaskan bahwa \textit{stunting} masih menjadi permasalahan kesehatan masyarakat yang memerlukan perhatian serius dan pendekatan yang komprehensif. Selain itu, upaya penanganan \textit{stunting} tidak hanya berfokus pada penurunan angka prevalensi, tetapi juga pada pemahaman faktor-faktor yang memengaruhi terjadinya kondisi tersebut secara lebih mendalam.
