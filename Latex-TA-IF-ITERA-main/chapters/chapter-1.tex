...
Penelitian sebelumnya menerapkan algoritma \textit{machine learning} untuk memprediksi stunting pada kalangan remaja di Ethiopia dan menemukan bahwa metode konvensional kurang mampu menangkap interaksi kompleks antarvariabel \cite{zemariam2025prediction}. Namun, penelitian tersebut dilakukan secara terbatas pada kelompok usia remaja dan wilayah tertentu, sehingga belum secara langsung dapat digeneralisasi dan masih memerlukan kajian tersendiri untuk ke skala nasional Indonesia yang mencakup berbagai karakteristik. Di Indonesia sendiri, pendekatan serupa telah mulai dieksplorasi, salah satunya oleh Pratama \textit{et al.} (2024) yang membandingkan berbagai algoritma untuk memprediksi prevalensi \textit{stunting} tingkat provinsi dan menemukan bahwa \textit{Random Forest} memberikan performa terbaik \cite{pratama2024comparison}. Meskipun demikian, studi di Indonesia tersebut masih berfokus pada pemodelan prediksi dan belum mengurai interaksi masing-masing variabel secara mendalam. Dengan demikian, penting untuk mengeksplorasi pendekatan serupa pada skala provinsi di Indonesia guna memahami faktor determinan \textit{stunting} berdasarkan kondisi lokal secara lebih transparan.
