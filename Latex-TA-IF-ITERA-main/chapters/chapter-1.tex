...
\begin{enumerate}[noitemsep]
    \item Data yang digunakan untuk penelitian ini terbatas pada Survei Status Gizi Indonesia (SSGI) tahun 2024 yang telah dipublikasikan oleh Kementerian Kesehatan RI. Perlu diketahui bahwa penelitian ini tidak menggunakan data tambahan dari sumber lain. Sehingga penelitian yang dilakukan bukan analisis \textit{time-series} antartahun dan memiliki ruang lingkup spasial terbatas pada 34 provinsi di Indonesia sesuai ketersediaan data.
