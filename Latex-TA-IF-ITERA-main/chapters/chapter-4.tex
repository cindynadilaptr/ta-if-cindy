...
\begin{longtable}{|c|p{0.55\textwidth}|c|}
    ...
    \hline
    2 & \textit{Mean Squared Error} (MSE) & \centering 3,15 \tabularnewline
    \hline
    3 & \textit{Root Mean Squared Error} (RMSE) & \centering 1,77 \tabularnewline
    \hline
    4 & \textit{R-Squared} ($R^2$) & \centering 0,9090 \tabularnewline
    \hline
    5 & \textit{Mean Absolute Percentage Error} (MAPE) & \centering 7,22\% \tabularnewline
    \hline
\end{longtable}
