...
\section{Konfigurasi Model dan Data} \label{sec:alat_bahan}

\subsection{Lingkungan Pengembangan Model}
...
\subsection{Karakteristik Data} \label{sec:karakteristik_data}
