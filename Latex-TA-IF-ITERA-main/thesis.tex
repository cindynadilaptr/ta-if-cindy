...
\begin{document}
    ...
    \title{Analisis Determinan \textit{Stunting} Tingkat Provinsi di Indonesia Menggunakan \textit{Random Forest} dan SHAP pada Data SSGI 2024}
    % Judul Tugas Akhir dalam Bahasa Inggris
    \titleEN{Analysis of Stunting Determinants at the Provincial Level in Indonesia Using Random Forest and SHAP on 2024 SSGI Data}
