...
\usepackage{float}    % Untuk posisi tabel [H]
\interfootnotelinepenalty=10000 % Mencegah footnote terpecah ke halaman berikutnya
...
\begin{document}
    ...
    \title{Analisis Determinan Penyebab \textit{Stunting} Provinsi di Indonesia: Aplikasi Model \textit{Random Forest} dan 
Interpretasi SHAP pada Data SSGI Tahun 2024}
    % Judul Tugas Akhir dalam Bahasa Inggris
    \titleEN{Determinant Analysis of Stunting Causes Across Indonesian Provinces: Application of Random Forest Model and SHAP Interpretation on SSGI 2024 Data}
